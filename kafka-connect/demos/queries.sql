...
INSERT INTO articles ( author, title, diagram, body, footnote ) VALUES
( "Soumitra", "Kafka Connect", "https://globomantics.com/kafka-connect-test.png", "It will never get easier..." , "1 - High Throughput" );

UPDATE articles SET  footnote = “1 - large sets of data” WHERE author = "Soumitra";

UPDATE articles SET  title = “Kafka Connect complete” WHERE author = "Soumitra";
